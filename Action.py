class Action:
    ...
    def reset():
        ...
        Action.Engine_Actor_RemoteRole = -1
        Action.Engine_Actor_DrawScale = -1
        Action.TAGame_CarComponent_TA_Vehicle = -1
        Action.TAGame_CarComponent_TA_ReplicatedActive = -1
        Action.TAGame_CarComponent_Boost_TA_ReplicatedBoostAmount = -1
        Action.TAGame_GameEvent_TA_ReplicatedRoundCountDownNumber = -1
        Action.TAGame_GameEvent_TA_ReplicatedGameStateTimeRemaining = -1
        Action.TAGame_GameEvent_TA_ReplicatedStateName = -1
        Action.TAGame_GameEvent_TA_BotSkill = -1
        Action.TAGame_GameEvent_TA_bHasLeaveMatchPenalty = -1
        Action.TAGame_GameEvent_Team_TA_MaxTeamSize = -1
        Action.TAGame_GameEvent_Soccar_TA_RoundNum = -1
        Action.TAGame_GameEvent_Soccar_TA_bBallHasBeenHit = -1
        Action.TAGame_GameEvent_Soccar_TA_SecondsRemaining = -1
        Action.Engine_Pawn_PlayerReplicationInfo = -1
        Action.TAGame_RBActor_TA_ReplicatedRBState = -1
        Action.TAGame_Vehicle_TA_ReplicatedSteer = -1
        Action.TAGame_Vehicle_TA_ReplicatedThrottle = -1
        Action.TAGame_Vehicle_TA_bReplicatedHandbrake = -1
        Action.TAGame_Vehicle_TA_bDriving = -1
        Action.TAGame_Car_TA_RumblePickups = -1
        Action.TAGame_Car_TA_TeamPaint = -1
        Action.TAGame_CameraSettingsActor_TA_CameraYaw = -1
        Action.TAGame_CameraSettingsActor_TA_CameraPitch = -1
        Action.TAGame_CameraSettingsActor_TA_bMouseCameraToggleEnabled = -1
        Action.TAGame_CameraSettingsActor_TA_bUsingSwivel = -1
        Action.TAGame_CameraSettingsActor_TA_bUsingBehindView = -1
        Action.TAGame_CameraSettingsActor_TA_ProfileSettings = -1
        Action.TAGame_CameraSettingsActor_TA_bUsingSecondaryCamera = -1
        Action.Engine_PlayerReplicationInfo_UniqueId = -1
        Action.Engine_PlayerReplicationInfo_Team = -1
        Action.Engine_PlayerReplicationInfo_PlayerID = -1
        Action.Engine_PlayerReplicationInfo_PlayerName = -1
        Action.Engine_PlayerReplicationInfo_Ping = -1
        Action.TAGame_PRI_TA_CurrentVoiceRoom = -1
        Action.TAGame_PRI_TA_SpectatorShortcut = -1
        Action.TAGame_PRI_TA_SteeringSensitivity = -1
        Action.TAGame_PRI_TA_Title = -1
        Action.TAGame_PRI_TA_PartyLeader = -1
        Action.TAGame_PRI_TA_ClientLoadoutsOnline = -1
        Action.TAGame_PRI_TA_ClientLoadouts = -1
        Action.TAGame_PRI_TA_ReplicatedGameEvent = -1
        Action.TAGame_PRI_TA_PlayerHistoryValid = -1
        Action.TAGame_PRI_TA_MatchScore = -1
        Action.TAGame_Ball_TA_HitTeamNum = -1
        Action.TAGame_CarComponent_Dodge_TA_DodgeTorque = -1
        Action.Engine_GameReplicationInfo_ServerName = -1
        Action.ProjectX_GRI_X_MatchGuid = -1
        Action.ProjectX_GRI_X_bGameStarted = -1
        Action.ProjectX_GRI_X_GameServerID = -1
        Action.ProjectX_GRI_X_Reservations = -1
        Action.ProjectX_GRI_X_ReplicatedServerRegion = -1
        Action.ProjectX_GRI_X_ReplicatedGamePlaylist = -1
        Action.TAGame_Team_TA_GameEvent = -1
        Action.TAGame_VehiclePickup_TA_NewReplicatedPickupData = -1
        Action.TAGame_PRI_TA_PersistentCamera = -1
        Action.TAGame_CameraSettingsActor_TA_PRI = -1
        Action.TAGame_Ball_TA_GameEvent = -1
        Action.TAGame_PRI_TA_MatchGoals = -1
        Action.TAGame_PRI_TA_MatchAssists = -1
        Action.TAGame_PRI_TA_MatchSaves = -1
        Action.TAGame_PRI_TA_MatchShots = -1
        Action.Engine_PlayerReplicationInfo_Score = -1
        Action.Engine_TeamInfo_Score = -1
        Action.TAGame_GameEvent_TA_bCanVoteToForfeit = -1
        Action.TAGame_Car_TA_ReplicatedDemolishGoalExplosion = -1
        Action.TAGame_GameEvent_Soccar_TA_ReplicatedScoredOnTeam = -1
        Action.Engine_Actor_bHidden = -1
        Action.TAGame_PRI_TA_bReady = -1
        Action.TAGame_PRI_TA_ReplicatedWorstNetQualityBeyondLatency = -1
        Action.TAGame_CarComponent_FlipCar_TA_FlipCarTime = -1
        Action.TAGame_GameEvent_Soccar_TA_MaxScore = -1
        Action.TAGame_Team_TA_ClubColors = -1
        Action.TAGame_Car_TA_ClubColors = -1
        Action.ProjectX_GRI_X_ReplicatedGameMutatorIndex = -1
        Action.TAGame_CarComponent_FlipCar_TA_bFlipRight = -1
        Action.TAGame_PRI_TA_bIsDistracted = -1
        Action.TAGame_Team_TA_Difficulty = -1
        Action.TAGame_Team_TA_CustomTeamName = -1
        Action.ProjectX_GRI_X_MatchGUID = -1
        Action.TAGame_GameEvent_Soccar_TA_SeriesLength = -1
        Action.TAGame_CarComponent_Dodge_TA_DodgeImpulse = -1
        Action.Engine_PlayerReplicationInfo_RemoteUserData = -1
        Action.TAGame_GameEvent_Soccar_TA_bOverTime = -1
        Action.TAGame_GameEvent_Soccar_TA_bClubMatch = -1
        Action.TAGame_Team_TA_ClubID = -1
        Action.Engine_PlayerReplicationInfo_bBot = -1
        Action.TAGame_PRI_TA_BotProductName = -1
        Action.TAGame_PRI_TA_ClubID = -1
        Action.TAGame_GameEvent_Team_TA_bForfeit = -1
        Action.TAGame_PRI_TA_PlayerHistoryKey = -1
        Action.Engine_PlayerReplicationInfo_bTimedOut = -1
        Action.Engine_ReplicatedActor_ORS_ReplicatedOwner = -1
        Action.TAGame_MaxTimeWarningData_TA_EndGameWarningEpochTime = -1
        Action.TAGame_MaxTimeWarningData_TA_EndGameEpochTime = -1
        Action.TAGame_Ball_TA_ReplicatedWorldBounceScale = -1
        Action.TAGame_PRI_TA_bIsInSplitScreen = -1
        Action.TAGame_RBActor_TA_bReplayActor = -1
        Action.TAGame_GameEvent_Soccar_TA_bUnlimitedTime = -1
        ...
        Action.Archetypes_GameEvent_GameEvent_Hockey = -1 # hockey puck
        Action.Archetypes_GameEvent_GameEvent_Basketball = -1 # basketball (hoops ball)
